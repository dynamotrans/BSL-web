...
- **Fichas reales de las 8 habitaciones** (`FICHAS` en `js/rooms.js`): Azahar, Jazmín, Dalia, Azucena, Tulipán, Malva, Girasol (sin precio → oculta), Margarita, con m² con decimales y camas 105/110/140. Botón de una vez en Ajustes "Cargar las 8 fichas" (solo aparece mientras haya nombres genéricos; no toca fotos, equipamiento, gastos ni fechas). Camas admitidas: 90/105/110/120/135/140/150.
